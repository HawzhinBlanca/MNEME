...
| `receipts/zk/` | Commitment-binding roundtrip corpus (partial; not Appendix B item 5) | PARTIAL — `privacy_fixture.json` exercises tagged BLAKE3 binding envelope only; **NOT zero-knowledge, NOT SNARK, NOT Plonky2** |
