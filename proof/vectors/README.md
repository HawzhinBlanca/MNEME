...
| `receipts/` | (5) passing + tampered retrieval receipt (ADS backend) | PASS — byte-pinned by `mneme-verify` `appendix_b_receipts` test (+ commitment-binding fixture under `receipts/zk/`; BLAKE3 envelope, not SNARK) |
