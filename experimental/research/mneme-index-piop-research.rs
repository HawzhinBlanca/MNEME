//! zkRAG-style PIOP research seam — Phase IV-A research only.
//!
//! See `docs/research/PHASE_IV_A_PIOP_SPIKE.md`. This module is a *labelled
//! research direction, not a feature.
...
pub const PIOP_RESEARCH_HONESTY: &str = "Phase IV-A zkRAG-style PIOP is not implemented research. This seam does not prove: \
...
pub const PIOP_RESEARCH_STATUS: &str = "not implemented (Phase IV-A research spike): global exact-NN over the committed set via a \
