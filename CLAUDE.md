...
scripts/ci/validation-lane.sh --help       # print usage without running a gate
scripts/ci/validation-lane.sh --list       # print supported lanes without running a gate
...
scripts/ci/validation-lane.sh p3-local     # local-only P3 scaffold checks; no external KMS/HSM/TEE proof
