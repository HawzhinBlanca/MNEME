...
[WORK_ORDER_EXTERNALIZED_MIND.md](WORK_ORDER_EXTERNALIZED_MIND.md)): ROBR-4 TEE
attestation, FCC-2/3 DP-influence / certified unlearning, TTRP KZG constant-size
proofs, MTL-2 A2A discovery, RPT real-model contamination harness. Each is blocked on
hardware or research, and each is labeled with its trust assumption rather than faked.
