...
|---|---:|---:|---:|---:|---|
| **I** — Verifiable retrieval + Certificate v1 | 5/5 | 0 | 0 | **100%** | Software-complete; zkANN distance-unbound documented; adversarial harness on PR #8. |
...
| **IV** — Scale & standard (research) | 0/4 | 4/4 | 0/4 | **~50%** | PIOP docs + federation verify sketch; no prover/verifier/SDK shipped. |
| **Deep inspection WO (P0–P2)** | 20/20 | 0 | 0 | **100%** | WO-1..WO-20 on `harden/differential-adversarial`. |
...
## On `harden/differential-adversarial` (beyond master)

- Generative adversarial harness for zkANN verifier (`66c4a08`) + distance-unbound finding doc.
...
**Not merged to master yet.** Await PR #8 CI green + operator merge.
